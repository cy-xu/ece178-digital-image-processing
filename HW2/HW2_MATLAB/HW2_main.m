...
output_imgs_simple_scaling{1} = linearStretching(test_imgs{1}, 0, 0+63, 4);
output_imgs_simple_scaling{2} = linearStretching(test_imgs{2}, 96, 96+63, 4);
output_imgs_simple_scaling{3} = linearStretching(test_imgs{3}, 0, 0+63, 4); %Artifact shows in this case
output_imgs_simple_scaling{4} = linearStretching(test_imgs{4}, 128, 128+63, 4); %Artifact shows in this case
